...
ax0.plot(r_km, Mars.g, label="Converged model")
ax1.plot(r_km, Mars.p/1E9, label="Converged model")
...
ax0.plot(r_km, Mars1.g, label="Converged min.")
ax1.plot(r_km, Mars1.p/1E9, label="Converged min.")
...
ax0.plot(r_km, Mars2.g, label="Converged max.")
ax1.plot(r_km, Mars2.p/1E9, label="Converged max.")
